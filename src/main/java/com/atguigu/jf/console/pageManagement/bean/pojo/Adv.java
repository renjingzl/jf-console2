...
public class Adv {
    ...
    private Long maxAdvOrder;
    
    private Long minAdvOrder;
    
    
    
    public Long getMaxAdvOrder() {
		return maxAdvOrder;
	}

	public void setMaxAdvOrder(Long maxAdvOrder) {
		this.maxAdvOrder = maxAdvOrder;
	}

	public Long getMinAdvOrder() {
		return minAdvOrder;
	}

	public void setMinAdvOrder(Long minAdvOrder) {
		this.minAdvOrder = minAdvOrder;
	}
